      ...
      <div className='col-12'>
        <div className='card docs'>
          ...
          <p>
            ...
            that allows creating React apps with no configuration. To get started extract the
...
`}
          ...
          <p>
            ...
            <b>http://localhost:3000/</b> to view the application.
          </p>
...
`}
          ...
          <p>
            That is it, you may now start with the development of your application using the Diamond
            template.
          </p>
...
`}
          ...
          <h4>Structure</h4>
          <p>
            Diamond consists of 3 main parts; the application layout, layout resources and theme
            resources for PrimeReact components. <i>App.js</i> inside app folder is the html
            template for the base layout, required resources for the layout are placed inside the{' '}
            <i>public/assets/layout</i> folder and similarly theme resources are inside{' '}
            <i>public/assets/theme</i> folder.
          </p>

          <h4>Template</h4>
          <p>
            Main layout is the template of the <i>App.js</i>, it is divided into a couple of child
            components such as topbar, content, menu, right menu, app search and footer. Here is
            template of the
            <i>App.js</i> component that implements the logic such as menu state, layout modes and
...
`}
          ...
          <h4>Menu</h4>
          <p>
            Menu is a separate component defined in <i>AppMenu.js</i> file based on PrimeReact
            MenuModel API. In order to define the menuitems, navigate to data section of{' '}
            <i>App.js</i> file and define your own model as a nested structure using the menu
            property. Here is the menu component from the demo application. Notice that menu object
            is bound to the model property of AppMenu component as shown above.
          </p>
...
`}
          ...
          <p>
            Dependencies of Layout are listed below and needs to be added to package.json. Only
            required dependency is PrimeReact where optional dependencies exist to enable certain
            components in PrimeReact.
          </p>
...
`}
          ...
          <h4>Theme</h4>
          <p>
            Diamond provides 30 PrimeReact themes out of the box. Setup of a theme is simple by
            including the css of theme to your bundle that are located inside assets/theme folder
            such as assets/theme/theme-amber-teal.css.
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              <i>../../sass/theme/_theme.scss</i> file.
            </li>
...
`}
          ...
          <p>
            ...
            following command so that sass generates the file whenever you make a customization.
            This builds all css files whenever a change is made to any scss file.
          </p>
          <AppCodeHighlight>
            {`
...
`}
          ...
          <p>
            Variables of the light component theme, see the{' '}
            <a href='https://www.primefaces.org/designer/api/primereact/5.0.0/'>
              Theme Designer API
            </a>{' '}
            for documentation.
          </p>
...
`}
          ...
          <h4>Menu Modes</h4>
          <p>
            Menu has 3 modes, static, overlay and slim. Layout container element in App.js is used
            to define which mode to use by adding specific classes. List below indicates the style
            classes for each mode.
          </p>
          <ul>
...
`}
          ...
          <h4>Menu Themes</h4>
          <p>
            In addition to layout options, menu offer themes when the general color scheme is light.
            Menu themes are only available in light mode by design as large surfaces can emit too
            much brightness in dark mode. Available options for the menu themes are the following;
          </p>
          <ul>
            <li>white</li>
            <li>darkgray</li>
          ...
          <h4>Grid CSS</h4>
          <p>
            Diamond uses PrimeReact Flex Grid CSS throughout the demos such as Dashboard, however
            any Grid library can be used with it since Diamond Layout itself does not depend on
            PrimeFlex CSS.
          </p>

          <h4>Customizing Styles</h4>
          <p>
            It is suggested to add your customizations in the following sass files under the
            &quot;sass/overrides&quot; folder instead of adding them to the scss files under sass
            folder to avoid maintenance issues after an update.
          </p>
          ...
          <p>
            Every change is included in <b>CHANGELOG.md</b> file at the root folder of the
            distribution along with the instructions to update.
          </p>
        </div>
      </div>
    </div>
