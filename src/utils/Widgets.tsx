            ...
            <div className='widget-chat'>
              <ul>
                ...
                <li className='message-own'>
                  <img src='assets/demo/images/avatar/onyamalimba.png' alt='diamond-layout' />
                  <div>
                    Dreamcatcher locavore iPhone chillwave, occupy trust fund slow-carb distillery
                    art party narwhal.
                  </div>
                </li>
              </ul>
        ...
        <div className='col-12 lg:col-4'>
          <div className='card widget-user-card'>
            <div className='user-card-header'>
              <img
                src='/assets/demo/images/avatar/rukvash.png'
                className='user-card-avatar border-circle'
                alt='diamond-layout'
              />
            </div>
