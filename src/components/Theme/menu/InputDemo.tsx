...
import CountryService from '../../../services/Theme/CountryService'
import NodeService from '../../../services/Theme/NodeService'
...
const InputDemo = () => {
  ...
  const [sliderValue, setSliderValue] = useState<string | number | [number, number] | readonly string[] | undefined>(
    undefined,
  )
  const [ratingValue, setRatingValue] = useState<number | null | undefined>(null)
  const [colorValue, setColorValue] = useState<string | ColorPickerRGBType | ColorPickerHSBType | undefined>('1976D2')
  ...
  const [selectedNode, setSelectedNode] = useState<TreeSelectSelectionKeys>(null)
  const [treeSelectNodes, setTreeSelectNodes] = useState<TreeNode[] | undefined>(undefined)
        ...
        <div className='card'>
          <div className='grid'>
            <div className='col-12'>
              <h5>Slider</h5>
              <InputText value={sliderValue as number} onChange={(e) => setSliderValue(parseInt(e.target.value))} />
              <Slider value={sliderValue as number} onChange={(e) => setSliderValue(e.value)} />
            </div>
            <div className='col-12 md:col-6'>
              <h5>Rating</h5>
              <Rating value={ratingValue as number} onChange={(e) => setRatingValue(e.value)} />
            </div>
            <div className='col-12 md:col-6'>
              <h5>ColorPicker</h5>
            ...
            <div className='col-12 md:col-6'>
              <div className='p-inputgroup'>
                <span className='p-inputgroup-addon p-inputgroup-addon-checkbox'>
                  <Checkbox checked={inputGroupValue} onChange={(e) => setInputGroupValue(e.checked)} value={true} />
                </span>
