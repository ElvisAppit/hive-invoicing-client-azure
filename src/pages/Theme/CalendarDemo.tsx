...
import EventService from '../../services/Theme/EventService'
            ...
            <div className='p-fluid'>
              ...
              <div className='field'>
                ...
                <PRCalendar
                  ...
                  onChange={(e) => setChangedEvent({ ...changedEvent, ...{ end: e.value } })}
                  showTime
                  appendTo={document.body}
                />
              </div>
              <div className='field-checkbox'>
                <Checkbox
                  ...
                  onChange={(e) => setChangedEvent({ ...changedEvent, ...{ allDay: e.value } })}
                />
