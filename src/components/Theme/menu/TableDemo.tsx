...
import CustomerService from '../../../services/Theme/CustomerService'
...
const TableDemo = () => {
  ...
  const [customers3, setCustomers3] = useState<any[] | undefined>([])
  ...
  const expandAll = () => {
    const _expandedRows = {} as DataTableExpandedRows
    products.forEach((p) => (_expandedRows[`${p}`] = true))
